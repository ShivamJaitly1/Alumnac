...
<header class="header-wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="logo">
                <a title="Alumnac" href="http://www.niecdelhi.ac.in">
              ...
              <div class="navbar navbar-default mainnav">
                ...
                <div class="collapse navbar-collapse">
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <!-- Contact Pages -->
                    <li><a href="gallery.php">Gallery</a></li><!-- /Contact Pages -->

                      <li ><a href="contactus.php">Contact Us</a></li>
<li><a href="#" align="right" id="login"><font color="#990000" >Login | Register</font></a></li>
