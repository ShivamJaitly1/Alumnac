...
<style>
  ...
  xhttp.open("GET", "trymsg.php?nme="+name, true);
  xhttp.send();
			}
            ...
            function register_popup(id,name)
            {
                ...
                element = element + '<div style="clear: both"></div></div><div id="resultMsg"><p id="demo">'+dis(id,name);+'</div></div>'; 
